...
public class NatureReadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nature_read);
        ...
        words = dbHelper.getNatureNames(); // getAnimalNames 메소드를 호출합니다.
        for (String word : words) {
            String englishName = dbHelper.getEnglishName(word, "Nature");
            if (englishName != null) {
