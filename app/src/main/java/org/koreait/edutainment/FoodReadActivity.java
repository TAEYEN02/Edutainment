...
public class FoodReadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_read);
        ...
        words = dbHelper.getFoodNames(); // getAnimalNames 메소드를 호출합니다.
        for (String word : words) {
            String englishName = dbHelper.getEnglishName(word, "Foods");
            if (englishName != null) {
