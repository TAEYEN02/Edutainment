...
public class RideReadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ride_read);
        ...
        words = dbHelper.getRideNames(); // getAnimalNames 메소드를 호출합니다.
        for (String word : words) {
            String englishName = dbHelper.getEnglishName(word, "Rides");
            if (englishName != null) {
