...
public class ThingReadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thing_read);
        ...
        words = dbHelper.getThingsNames(); // getAnimalNames 메소드를 호출합니다.
        for (String word : words) {
            String englishName = dbHelper.getEnglishName(word, "Things");
            if (englishName != null) {
